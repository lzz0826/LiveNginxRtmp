...
/**
 * @description 使用摄相头，推送到SRS服务器 TODO
 */

public class PushStreamLive {

    /**
     * 直播推流实现
     */
    public void getRecordPush(String outputPath, int v_rs) throws Exception, FrameRecorder.Exception, InterruptedException {
