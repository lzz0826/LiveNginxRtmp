...
public class PushMp4 {
     ...
     * 本地MP4文件的完整路径
     */
    private static final String MP4_FILE_PATH = "/Users/admin/IdeaProjects/LiveNginxRtmp/PushStreaming/mp4/test99.mp4";

    /**
     * SRS的推流地址
     */
    private static final String SRS_PUSH_ADDRESS = "rtmp://127.0.0.1:1935/live/test?token=123456";
